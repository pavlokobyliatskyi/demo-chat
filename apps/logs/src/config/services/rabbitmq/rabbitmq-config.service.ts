...
export class RabbitMQConfigService {
  ...
  public getRabbitMQUser(): string {
    return this.configService.get('LOGS_RABBITMQ_USER');
  }

  public getRabbitMQPassword(): string {
    return this.configService.get('LOGS_RABBITMQ_PASSWORD');
  }

  public getRabbitMQHost(): string {
    return this.configService.get('LOGS_RABBITMQ_HOST');
  }

  public getRabbitMQPort(): number {
    return Number(this.configService.get('LOGS_RABBITMQ_PORT'));
  }
}
