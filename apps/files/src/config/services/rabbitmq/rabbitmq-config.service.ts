...
export class RabbitMQConfigService {
  ...
  public getRabbitMQUser(): string {
    return this.configService.get('FILES_RABBITMQ_USER');
  }

  public getRabbitMQPassword(): string {
    return this.configService.get('FILES_RABBITMQ_PASSWORD');
  }

  public getRabbitMQHost(): string {
    return this.configService.get('FILES_RABBITMQ_HOST');
  }

  public getRabbitMQPort(): number {
    return Number(this.configService.get('FILES_RABBITMQ_PORT'));
  }
}
